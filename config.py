def cnndm_setting(args):
    ...
    args.mle_weight = getattr(args, "mle_weight", 1.0)
    ...
    args.feat_names = getattr(args, "feat_names", ['article', 'highlights'])
    ...
    args.src_data_path = getattr(args, "src_data_path", "/apdcephfs_qy3/share_1565115/jonxie/data_base/cnn_dailymail")
...
def xsum_setting(args):
    ...
    args.mle_weight = getattr(args, "mle_weight", 1.0)
    args.rank_weight = getattr(args, "rank_weight", 10)
    args.model_type = getattr(args, "model_type", "/apdcephfs_qy3/share_1565115/jonxie/model_base/pegasus-xsum")
    args.warmup_steps = getattr(args, "warmup_steps", 10000)
    args.normalize = getattr(args, "normalize", True)
    args.feat_names = getattr(args, "feat_names", ['document', 'summary'])
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 970903)
    args.no_gold = getattr(args, "no_gold", False)
    args.pretrained = getattr(args, "pretrained", None)
...
def samsum_setting(args):
    ...
    args.warmup_steps = getattr(args, "warmup_steps", 10000)
    args.normalize = getattr(args, "normalize", True)
    args.feat_names = getattr(args, "feat_names", ['dialogue', 'summary'])
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 970903)
    args.no_gold = getattr(args, "no_gold", False)
    args.pretrained = getattr(args, "pretrained", None)
    ...
    args.scale = getattr(args, "scale", 0.01)
    args.score_mode = getattr(args, "score_mode", "log")
    args.dataset = getattr(args, "dataset", "/apdcephfs_qy3/share_1565115/jonxie/data_base/GECSum/samsum")
    args.src_data_path = getattr(args, "src_data_path", "/apdcephfs_qy3/share_1565115/jonxie/data_base/samsum")
    args.update_interval = getattr(args, "update_interval", 2)
    args.max_len = getattr(args, "max_len", 80)
    args.max_num = getattr(args, "max_num", 16)
    args.smooth = getattr(args, "smooth", 0.1)
...
def meqsum_setting(args):
    ...
    args.warmup_steps = getattr(args, "warmup_steps", 10000)
    args.normalize = getattr(args, "normalize", True)
    args.feat_names = getattr(args, "feat_names", ['CHQ', 'Summary'])
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 970903)
    args.no_gold = getattr(args, "no_gold", False)
    args.pretrained = getattr(args, "pretrained", None)
    ...
    args.scale = getattr(args, "scale", 0.01)
    args.score_mode = getattr(args, "score_mode", "log")
    args.dataset = getattr(args, "dataset", "/apdcephfs_qy3/share_1565115/jonxie/data_base/GECSum/meqsum")
    args.src_data_path = getattr(args, "src_data_path", "/apdcephfs_qy3/share_1565115/jonxie/data_base/meqsum_ours")
    args.update_interval = getattr(args, "update_interval", 2)
    args.max_len = getattr(args, "max_len", 80)
    args.max_num = getattr(args, "max_num", 16)
    args.smooth = getattr(args, "smooth", 0.1)
